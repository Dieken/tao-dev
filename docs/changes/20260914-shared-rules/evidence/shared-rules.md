...
**输入指纹:** 受检源码见 [SHA-256 清单](inputs.sha256)，共 39 个文件，包含计划、长期开发文档、入口、分配记录及完整插件源码；清单本身的 SHA-256 为 `1658847618460a3deda18de4232595562ef7cf1e745449c95e5a7e30b09fce32`。仅证据目录自身不进入指纹，防止保存报告使自身失效；其结构另经静态检查。
...
<!-- tao:field reports -->
**报告:** [执行输出](validation.txt) 的 SHA-256 为 `222fa99bce0fe8198d7014b4499d19fdb72c96aa44373b898bf8c0e8c6a89b16`；受检文件另见输入清单。
