...
def prepare(project, identity, reason, replacements):
    ...
    result = validate(project.root, project.sources(), book_root=project.book_root,
                      retirement_directory=project.paths['retired'], section_redirects=project.section_redirects, diagnostic_locale=project.diagnostic_locale)
    ...
    proposed = validate(project.root, project.sources(), book_root=project.book_root,
                        retirement_directory=project.paths['retired'], overrides=overrides, section_redirects=project.section_redirects, diagnostic_locale=project.diagnostic_locale)
